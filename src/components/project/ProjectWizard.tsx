...
const STR = {
  en: {
    ...
    sizeNotice: "Maximum file size: 1 GB per file. For larger datasets, simulation outputs, or computational models, please contact the EASER team. Future versions of the platform will support external cloud storage solutions.",
  ...
  es: {
    ...
    sizeNotice: "Tamaño máximo de archivo: 1 GB por archivo. Para conjuntos de datos más grandes, salidas de simulación o modelos computacionales, contacta al equipo EASER. Las futuras versiones de la plataforma admitirán almacenamiento en la nube.",
