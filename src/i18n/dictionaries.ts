...
export const en = {
  common: {
    ...
    documentation: "Documentation", dashboard: "My Dashboard", profile: "Profile",
  ...
  contribute: {
    ...
    technical: "Technical details", addAuthor: "+ Add author", addInstitution: "+ Add institution",
...
export const es: Dict = {
  common: {
    ...
    documentation: "Documentación", dashboard: "Mi panel", profile: "Perfil",
  ...
  contribute: {
    ...
    technical: "Detalles técnicos", addAuthor: "+ Añadir autor", addInstitution: "+ Añadir institución",
